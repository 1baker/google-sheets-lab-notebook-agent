...
def build_experiment_entry_from_tables(
    ...
    return {
        ...
        "equipment_id": experiment.get("equipment_id", ""),
        "started_at": experiment.get("started_at", ""),
        "completed_at": experiment.get("completed_at", ""),
        "reviewer": experiment.get("reviewer", ""),
        "reviewed_at": experiment.get("reviewed_at", ""),
        "template_id": experiment.get("template_id", ""),
        "template_version": experiment.get("template_version", ""),
        "review_process": experiment.get("review_process", ""),
        "record_fingerprint": experiment.get("record_fingerprint", ""),
